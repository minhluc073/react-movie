          ...
          <Stack direction="row" sx={{ px: 1 }}>
            ...
            <Box sx={{ p: 2 }}>
              ...
              <Stack
                ...
                sx={{ alignItems: { xs: "flex-start", md: "flex-end" }, my: 2 }}
              >
                <Stack
                  direction="row"
                  spacing={1}
              ...
              <Typography
                variant="body2"
                sx={{ px: 1, pt: 2, color: "primary.light", maxWidth: "10rem" }}
              >
                {movie.duration && movie.duration} - {movie.date && movie.date}
              </Typography>
              <Typography
                variant="body2"
                sx={{ px: 1,pt:1, color: "primary.light", maxWidth: "10rem" }}
              >
                {movie.countries &&
                  movie.countries.length > 0 &&
                  movie.countries.map((country) => `(${country.iso_3166_1})`)}
              </Typography>
            </Box>
          </Stack>
